...
namespace Server.Migrations
{
    ...
    [Migration("20250422033739_PlayerStatInfo")]
    partial class PlayerStatInfo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Server.DB.PlayerDb", b =>
                {
                    ...
                    b.OwnsOne("Protocol.StatInfo", "StatInfo", b1 =>
                        {
                            b1.Property<int>("PlayerDbId")
                                .HasColumnType("int");
                            ...
                            b1.Property<int>("TotalExp")
                                .HasColumnType("int");

                            b1.HasKey("PlayerDbId");
